...
std::vector<uint32_t> subtract(const integer_number &first,
                               const integer_number &second, size_t offset);
...
public:
  ...
  static integer_number table_function_nn(const integer_number &first,
                                          const integer_number &second); // -  -
  static integer_number table_function_np(const integer_number &first,
                                          const integer_number &second); // -  +
  static integer_number table_function_pn(const integer_number &first,
                                          const integer_number &second); // +  -
  static integer_number table_function_pp(const integer_number &first,
                                          const integer_number &second); // +  +
  ...
  devide_mod(const integer_number &denominator) const;
...
public:
  ...
  number &abs();
  void change_sgn() { numerator.change_sign(); }
};
